...
| 16/7 | **Fase E2 LIVE**: Quiz-quests + curriculum pr. trinforløb — quest-felt `quiz {draw, pass, questions[{q, answers}]}` (answers[0] = facit i data, runtime-shuffle i UI); quiz-overlay i spiller-appen m. ét spørgsmål ad gangen, feedback, resultat; bestået → completion m. `quizScore` som admin ser ("🧠 Quiz: 10/10"); ikke bestået → prøv igen frit. 5 quiz-banker: matematik plus/minus [0,3], tabeller [2,6], brøk/procent [4,6]; engelsk gloser basis [3,4], øvet [5,7], grammatik [5,9] + billedbogs-quest [3,4]. Re-tilpasning ved klasseskift: `retuneModule` (union af tildelte heltes trin) via sektion i anbefalings-dialogen. Quest-editor bevarer nu quiz/grades-felter (var en data-tabs-bug). E2E: e2e_faseE2.py grøn + E1/C-regression |
